...
{   
    ...
    {           
        for(int i=0;i<MET.ROW;i++){
            for(int j=0;j<MET.COL;j++){
               if(MET.myArray[i,j]) MET.myArray[i, j].SetActive(true);
            }
        }
        for (int i = 0; i < realMazeController.ROW-1; i++)
        {
            for (int j = 0; j < realMazeController.COL; j++)
            {
                if(realMazeController.verticalWall[i, j])realMazeController.verticalWall[i, j].SetActive(false);
            }
        }

        for(int i=0;i<realMazeController.ROW;i++){
            for(int j=0;j<realMazeController.COL-1;j++){
                if(realMazeController.horizontolwall[i,j])realMazeController.horizontolwall[i,j].SetActive(false);
            }
        }
    ...
    public void changeMicroMouse(){
        for(int i=0;i<MET.ROW;i++){
            for(int j=0;j<MET.COL;j++){
               if(MET.myArray[i,j]) MET.myArray[i, j].SetActive(false);
            }
        }
        for (int i = 0; i < realMazeController.ROW-1; i++)
        {
            for (int j = 0; j < realMazeController.COL; j++)
            {
               if(realMazeController.verticalWall[i, j])realMazeController.verticalWall[i, j].SetActive(true);
            }
        }

        for(int i=0;i<realMazeController.ROW;i++){
            for(int j=0;j<realMazeController.COL-1;j++){
                if(realMazeController.horizontolwall[i,j])realMazeController.horizontolwall[i,j].SetActive(true);
            }
        }
